...
try
    ...
    if numMasks > 0
        ...
        [textureFeatures, maskAreas] = computeAllMaskTextures(Igray_cropped_dbl, allMasksExclusive, numMasks);
        if saveDebug || SHOW_DEBUG_FIGURES
        ...
        [bg_mask_idx, lumen_candidates] = identifyBackgroundMask(allMasksExclusive, maskAreas, ...
        ...
        % --- 4.3: Identify 3D-printed anchor: surrounding masks via ray casting
        [anchor_mask_indices, anchor_mask, anchor_texture, ...
        ...
        if saveDebug || SHOW_DEBUG_FIGURES
            saveStep4_3Debug(I_cropped, allMasksExclusive, anchor_mask_indices, anchor_mask, ...
                anchor_top_Y, anchor_bot_Y, textureFeatures, maskAreas, ...
                Hc, Wc, debugFolder, baseName, SHOW_DEBUG_FIGURES);
        end
        ...
        [lumen_candidates, removed_outside_anchor] = ...
            eliminateOutsideAnchorBounds(allMasksExclusive, lumen_candidates, anchor_top_Y, anchor_bot_Y);

        if saveDebug || SHOW_DEBUG_FIGURES
            saveStep4_5Debug(I_cropped, allMasksExclusive, lumen_candidates, ...
                removed_outside_anchor, anchor_top_Y, anchor_bot_Y, ...
                debugFolder, baseName, SHOW_DEBUG_FIGURES);
        end

        % --- 4.6: imfill candidate detection ---
        [lumen_candidates, candidate_polarity, candidate_scores, imfill_cache, ...
            anchor_score, ~, ~, diff_gray_full, diff_inv_full] = ...
            detectImfillCandidates(Igray_cropped_u8, allMasksExclusive, maskAreas, ...
            lumen_candidates, anchor_mask_indices, anchor_mask);
        ...
        [lumen_candidates, ~, ~, selected_mask_idx, selected_polarity] = ...
            ...
            candidate_polarity, candidate_scores, Hc, Wc);
